...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://picbed.skylerplus.top/bg/daily.jpg);
    --darkmode-bg:url(https://picbed.skylerplus.top/bg/nightbg.jpg);
    --mobileday-bg: url(https://picbed.skylerplus.top/bg/daily.jpg);
    --mobilenight-bg: url(https://picbed.skylerplus.top/bg/nightbg.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
